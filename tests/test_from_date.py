...
def test_interval(date_start, date_end, date_in_interval):
    objdate = ForDate()
    CustomAssert.my_assert(objdate.in_interval(date_start, date_end, date_in_interval)==True)
...
def test2_interval(date_start, date_end, date_in_interval):
    objdate = ForDate()
    CustomAssert.my_assert(objdate.in_interval(date_start, date_end, date_in_interval))
...
def test_indiff(dat1):
    objdate= ForDate()
    CustomAssert.my_assert(objdate.date_difference(dat1))
...
def test_comparsdate(date_1, date_2):
    objdate= ForDate()
    CustomAssert.my_assert(objdate.compars_date(date_1, date_2))
